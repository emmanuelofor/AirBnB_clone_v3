#!/usr/bin/python3
'''
    RESTful API for managing the Place class
'''
...
def get_place_by_city(city_id):
    '''
        Returns a list of places within a specified city
    '''
...
def get_place_id(place_id):
    '''
        Returns a place and its corresponding id
    '''
...
def create_place(city_id):
    '''
        Creates a new place object associated with a city using a POST request
    '''
...
def update_place(place_id):
    '''
        Updates an existing place object using a PUT request
    '''
    if not request.get_json():
        return jsonify({"error": "Not a JSON"}), 400
